...
CATEGORY_TEMPLATES: Dict[str, Dict[str, Any]] = {
    "ROAD_HAZARD": {
        "action_steps": [
            ...
            "Dewater cavity and clear accumulated standing water or debris for inspection",
            "Inspect underlying road sub-base for erosion or instability",
            "Apply high-durability cold-mix or hot asphalt patch",
            "Compact patch flush with surrounding roadway",
            "Collect post-repair completion photographic evidence showing restored road surface"
        ],
        "materials": [
