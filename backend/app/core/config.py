...
class Settings(BaseSettings):
    ...
    # Security & Auth
    SECRET_KEY: str = "civiclens_super_secret_jwt_key_2026_production"
    ACCESS_TOKEN_EXPIRE_MINUTES: int = 60 * 24 # 24 hours

    # Database (Absolute path ensuring deterministic DB binding regardless of working directory)
    DATABASE_URL: str = f"sqlite:///{os.path.abspath(os.path.join(os.path.dirname(__file__), '../../civiclens.db'))}"
