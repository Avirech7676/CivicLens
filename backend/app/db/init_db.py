...
from app.models.entities import Incident, Report, WorkOrder, StatusLog, Notification
...
def seed_demo_data():
    ...
    try:
        ...
        # Lat: 37.7749, Lon: -122.4194 (Concentrated within 150m)
        # =========================================================================
        lat_a, lon_a = 37.7749, -122.4194
        ...
        # Lat: 37.7810, Lon: -122.4110 (~800m away from Hotspot A)
        # =========================================================================
        lat_b, lon_b = 37.7810, -122.4110
        ...
        inc12 = Incident(
            ...
            title="Single Streetlight Outage at West Ave",
        ...
        rep11 = Report(id="rep-iso-1", citizen_id="citizen-iso-1", description="Peeling bench paint", latitude=37.7950, longitude=-122.4000, incident_id=inc11.id)
        rep12 = Report(id="rep-iso-2", citizen_id="citizen-iso-2", description="Lamp out at West Ave", latitude=37.7600, longitude=-122.4400, incident_id=inc12.id)
        ...
        reps_single = [
            Report(id=f"rep-single-{i}", citizen_id=f"citizen-s-{i}", description=f"Sinkhole report #{i}", latitude=37.7500, longitude=-122.4300, incident_id=inc13.id)
            for i in range(1, 16)
        ]
